import"./lit-html-_TTrhfbU.js";import{a as h,x as e}from"./lit-element-nGwg5-HZ.js";import{r as u}from"./class-map-D78VnDIV.js";import{c as f,R as w,E as y}from"./index-hE0wlW8G.js";import{c as g}from"./index-DSEXG_NF.js";import"./index-BQ01FR-P.js";import{H as v}from"./HelpersUtil-kp2B7IoN.js";const b=f`
  :host {
    display: block;
  }
...
`;var p=function(n,t,a,r){var s=arguments.length,i=s<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,a):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,t,a,r);else for(var c=n.length-1;c>=0;c--)(o=n[c])&&(i=(s<3?o(i):s>3?o(t,a,i):o(t,a))||i);return s>3&&i&&Object.defineProperty(t,a,i),i};let l=class extends h{constructor(){super(...arguments),this.resizeObserver=void 0,this.unsubscribe=[],this.status="hide",this.view=w.state.view}firstUpdated(){this.status=v.hasFooter()?"show":"hide",this.unsubscribe.push(w.subscribeKey("view",t=>{this.view=t,this.status=v.hasFooter()?"show":"hide",this.status==="hide"&&document.documentElement.style.setProperty("--apkt-footer-height","0px")})),this.resizeObserver=new ResizeObserver(t=>{for(const a of t)if(a.target===this.getWrapper()){const r=`${a.contentRect.height}px`;document.documentElement.style.setProperty("--apkt-footer-height",r)}}),this.resizeObserver.observe(this.getWrapper())}render(){return e`
    ...
    </wui-flex>`}onNetworkHelp(){y.sendEvent({type:"track",event:"CLICK_NETWORK_HELP"}),w.push("WhatIsANetwork")}getWrapper(){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector("div.container")}};l.styles=[b];p([u()],l.prototype,"status",void 0);p([u()],l.prototype,"view",void 0);l=p([g("w3m-footer")],l);const k=f`
  :host {
    display: block;
    width: inherit;
  }
`;var d=function(n,t,a,r){var s=arguments.length,i=s<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,a):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,t,a,r);else for(var c=n.length-1;c>=0;c--)(o=n[c])&&(i=(s<3?o(i):s>3?o(t,a,i):o(t,a))||i);return s>3&&i&&Object.defineProperty(t,a,i),i};let m=class extends h{constructor(){super(),this.unsubscribe=[],this.viewState=w.state.view,this.history=w.state.history.join(","),this.unsubscribe.push(w.subscribeKey("view",()=>{this.history=w.state.history.join(","),document.documentElement.style.setProperty("--apkt-duration-dynamic","var(--apkt-durations-lg)")}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t()),document.documentElement.style.setProperty("--apkt-duration-dynamic","0s")}render(){return e`${this.templatePageContainer()}`}templatePageContainer(){return e`<w3m-router-container
