import"./lit-html-_TTrhfbU.js";import{a as f,x as u}from"./lit-element-nGwg5-HZ.js";import{n as d,r as c}from"./class-map-D78VnDIV.js";import{c as m,d as N,b as x,C as H,a4 as l,r as W,e as V,R as g,N as L,o as q,S as _,E as M,g as Y,W as K}from"./index-hE0wlW8G.js";import{c as w,U as $}from"./index-DSEXG_NF.js";import"./index-CPxfyDQe.js";import"./index-8bO_JXwy.js";import{e as O,n as D}from"./ref-3T9CwXfV.js";import{n as G,s as J}from"./ConstantsUtil-Dmg8YACJ.js";import"./index-DHUcy1MU.js";import"./index-D9dCRkAn.js";import{S as F}from"./SwapController-CPa0BEl_.js";import"./index-DOcfw5yA.js";import"./index-DgapEBFM.js";import"./index-C_TL-L_o.js";import"./index-D0yfWJaP.js";import"./index-DLRb7gC7.js";import{o as Q}from"./if-defined-8ZKh-W65.js";import"./index-B1yGdhtz.js";import"./index-TjLUG_Bo.js";import"./jsx-runtime-DF5SV9au.js";import"./walletConnect-BmfqopVd.js";import"./index.es-CQTua3R0.js";import"./privyConnector--nGFtbB8.js";import"./isAddressEqual-BZ0F7Med.js";import"./sha3-C47P6eDd.js";import"./_u64-CPCIv9dJ.js";import"./hooks.module-B3Nfv_UP.js";import"./index-7JkPJWjm.js";import"./index-BHYcTakE.js";import"./sha2-Cuix5xAA.js";import"./index-T1rz9UxS.js";import"./async-directive-BuaOoYpE.js";import"./index-CYUNKNU6.js";const X=m`
  :host {
    width: 100%;
    height: 100px;
...
`;var E=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let A=class extends f{constructor(){super(...arguments),this.inputElementRef=O(),this.disabled=!1,this.value="",this.placeholder="0"}render(){var t;return(t=this.inputElementRef)!=null&&t.value&&this.value&&(this.inputElementRef.value.value=this.value),u`<input
      ${D(this.inputElementRef)}
      type="text"
      inputmode="decimal"
      pattern="[0-9,.]*"
    ...
    /> `}dispatchInputChangeEvent(t){var r,o;const n=t.data;if(n&&((r=this.inputElementRef)!=null&&r.value))if(n===","){const i=this.inputElementRef.value.value.replace(",",".");this.inputElementRef.value.value=i,this.value=`${this.value}${i}`}else G.test(n)||(this.inputElementRef.value.value=this.value.replace(new RegExp(n.replace(J,"\\$&"),"gu"),""));this.dispatchEvent(new CustomEvent("inputChange",{detail:(o=this.inputElementRef.value)==null?void 0:o.value,bubbles:!0,composed:!0}))}};A.styles=[W,V,Z];E([d({type:Boolean})],A.prototype,"disabled",void 0);E([d({type:String})],A.prototype,"value",void 0);E([d({type:String})],A.prototype,"placeholder",void 0);A=E([w("wui-input-amount")],A);const ee=m`
  :host {
    width: 100%;
    height: 100px;
    border-radius: ${({borderRadius:e})=>e[5]};
...
`;var b=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let h=class extends f{constructor(){super(),this.unsubscribe=[],this.token=l.state.token,this.sendTokenAmount=l.state.sendTokenAmount,this.receiverAddress=l.state.receiverAddress,this.receiverProfileName=l.state.receiverProfileName,this.loading=l.state.loading,this.message="Preview Send",this.token&&(this.fetchBalances(),this.fetchNetworkPrice()),this.unsubscribe.push(l.subscribe(t=>{this.token=t.token,this.sendTokenAmount=t.sendTokenAmount,this.receiverAddress=t.receiverAddress,this.receiverProfileName=t.receiverProfileName,this.loading=t.loading}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return this.getMessage(),u` <wui-flex flexDirection="column" .padding=${["0","4","4","4"]}>
    ...
    </wui-flex>`}async fetchBalances(){await l.fetchTokenBalance(),l.fetchNetworkBalance()}async fetchNetworkPrice(){await F.getNetworkTokenPrice()}onButtonClick(){g.push("WalletSendPreview")}getMessage(){var t;this.message="Preview Send",this.receiverAddress&&!N.isAddress(this.receiverAddress,x.state.activeChain)&&(this.message="Invalid Address"),this.receiverAddress||(this.message="Add Address"),this.sendTokenAmount&&this.token&&this.sendTokenAmount>Number(this.token.quantity.numeric)&&(this.message="Insufficient Funds"),this.sendTokenAmount||(this.message="Add Amount"),this.sendTokenAmount&&((t=this.token)!=null&&t.price)&&(this.sendTokenAmount*this.token.price||(this.message="Incorrect Value")),this.token||(this.message="Select Token")}};h.styles=te;b([c()],h.prototype,"token",void 0);b([c()],h.prototype,"sendTokenAmount",void 0);b([c()],h.prototype,"receiverAddress",void 0);b([c()],h.prototype,"receiverProfileName",void 0);b([c()],h.prototype,"loading",void 0);b([c()],h.prototype,"message",void 0);h=b([w("w3m-wallet-send-view")],h);const ie=m`
  .contentContainer {
    height: 440px;
    overflow: scroll;
...
`;var B=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let C=class extends f{constructor(){super(...arguments),this.text=""}render(){return u`<wui-text variant="lg-regular" color="primary">${this.text}</wui-text>
      ${this.imageTemplate()}`}imageTemplate(){return this.address?u`<wui-avatar address=${this.address} .imageSrc=${this.imageSrc}></wui-avatar>`:this.imageSrc?u`<wui-image src=${this.imageSrc}></wui-image>`:u`<wui-icon size="lg" color="inverse" name="networkPlaceholder"></wui-icon>`}};C.styles=[W,V,ne];B([d({type:String})],C.prototype,"text",void 0);B([d({type:String})],C.prototype,"address",void 0);B([d({type:String})],C.prototype,"imageSrc",void 0);C=B([w("wui-preview-item")],C);const re=m`
  :host {
    display: flex;
...
`;var j=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let T=class extends f{constructor(){super(...arguments),this.imageSrc=void 0,this.textTitle="",this.textValue=void 0}render(){return u`
      <wui-flex justifyContent="space-between" alignItems="center">
        <wui-text variant="lg-regular" color="primary"> ${this.textTitle} </wui-text>
        ${this.templateContent()}
      </wui-flex>
    `}templateContent(){return this.imageSrc?u`<wui-image src=${this.imageSrc} alt=${this.textTitle}></wui-image>`:this.textValue?u` <wui-text variant="md-regular" color="secondary"> ${this.textValue} </wui-text>`:u`<wui-icon size="inherit" color="default" name="networkPlaceholder"></wui-icon>`}};T.styles=[W,V,re];j([d()],T.prototype,"imageSrc",void 0);j([d()],T.prototype,"textTitle",void 0);j([d()],T.prototype,"textValue",void 0);T=j([w("wui-list-content")],T);const oe=m`
  :host {
    display: flex;
    width: auto;
