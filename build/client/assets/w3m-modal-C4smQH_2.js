import"./lit-html-_TTrhfbU.js";import{i as v,a as f,x as a}from"./lit-element-nGwg5-HZ.js";import{n as w,r as d}from"./class-map-D78VnDIV.js";import{o as q}from"./if-defined-8ZKh-W65.js";import{k as ve,p as fe,s as ge,l as be,M as g,S as se,R as l,h as P,A as K,j as ce,i as le,C as m,m as Y,n as ye,o as S,E as ie,O as E,q as F,u as oe,v as T,x as H,T as xe,y as Ce,z as ke,B as Se}from"./core-DM7wqpT0.js";import{c as u,U as We}from"./index-BXDGUHhm.js";import"./index-B1yGdhtz.js";import"./index-TjLUG_Bo.js";import"./jsx-runtime-DF5SV9au.js";import"./walletConnect-BmfqopVd.js";import"./index.es-CQTua3R0.js";import"./fallback-zV5QAe9Q.js";import"./async-directive-BuaOoYpE.js";const p=fe({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return be(p,()=>r(p))},subscribeKey(r,e){return ge(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
